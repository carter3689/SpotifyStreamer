...
public class DrawerMenuContents {
    ...
    public DrawerMenuContents(Context ctx) {
        ...
        activities[1] = ActivityPlaceholder.class;
        items.add(populateDrawerItem(ctx.getString(R.string.SEARCH),
            R.drawable.ic_playlist_music_black_24dp));

        //activities[2] = ActivityPlaceholder.class;
        //items.add(populateDrawerItem("Search",R.drawable.common_signin_btn_icon_dark));
    }
